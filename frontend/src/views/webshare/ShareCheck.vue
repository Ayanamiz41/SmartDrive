      ...
      <div class="code-panel">
        <div class="file-info">
          ...
          <div class="share-info">
            ...
            <div class="file-deleted" v-if="shareInfo.fileDeleted" style="color:#f56c6c;margin-top:5px">
              ⚠ 该文件已被删除
            </div>
          </div>
        </div>
        <div class="code-body">
          <div class="tips">请输入5位提取码：</div>
            ...
            >
              ...
              <el-form-item prop="code">
                <el-input
				  ...
				  @input="formData.code = formData.code.slice(0, 5)"
                ></el-input>
